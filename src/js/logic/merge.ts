  ...
  try {
    ...
    for (const file of state.files) {
      ...
      for (let i = 1; i <= pdfjsDoc.numPages; i++) {
        ...
        wrapper.className =
          'page-thumbnail relative cursor-move flex flex-col items-center gap-1 p-2 border-2 border-gray-600 hover:border-fuchsia-500 rounded-lg bg-tool-card transition-colors';
        ...
        pageNumDiv.className =
          'absolute top-1 left-1 bg-fuchsia-600 text-white text-xs px-2 py-1 rounded-md font-semibold shadow-lg';
...
export async function setupMergeTool() {
  ...
  (state.files as File[]).forEach((f) => {
    ...
    li.className =
      'bg-tool-card p-3 rounded-lg border border-gray-600 hover:border-fuchsia-500 transition-colors';
    ...
    input.className =
      'w-full bg-input-bg border border-gray-600 text-white rounded-md p-2 text-sm mt-1 focus:border-fuchsia-500 focus:ring-1 focus:ring-fuchsia-500 transition-colors';
  ...
  newFileModeBtn.addEventListener('click', () => {
    ...
    newFileModeBtn.classList.add('bg-fuchsia-600', 'text-white');
    // @ts-expect-error TS(2339) FIXME: Property 'classList' does not exist on type 'Node'... Remove this comment to see the full error message
    newFileModeBtn.classList.remove('bg-gray-700', 'text-gray-300');
    // @ts-expect-error TS(2339) FIXME: Property 'classList' does not exist on type 'Node'... Remove this comment to see the full error message
    newPageModeBtn.classList.remove('bg-fuchsia-600', 'text-white');
    // @ts-expect-error TS(2339) FIXME: Property 'classList' does not exist on type 'Node'... Remove this comment to see the full error message
  ...
  newPageModeBtn.addEventListener('click', async () => {
    ...
    // @ts-expect-error TS(2339) FIXME: Property 'classList' does not exist on type 'Node'... Remove this comment to see the full error message
    newPageModeBtn.classList.add('bg-fuchsia-600', 'text-white');
    // @ts-expect-error TS(2339) FIXME: Property 'classList' does not exist on type 'Node'... Remove this comment to see the full error message
    newPageModeBtn.classList.remove('bg-gray-700', 'text-gray-300');
    // @ts-expect-error TS(2339) FIXME: Property 'classList' does not exist on type 'Node'... Remove this comment to see the full error message
    newFileModeBtn.classList.remove('bg-fuchsia-600', 'text-white');
    // @ts-expect-error TS(2339) FIXME: Property 'classList' does not exist on type 'Node'... Remove this comment to see the full error message
