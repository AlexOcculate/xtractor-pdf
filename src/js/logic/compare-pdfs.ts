...
function setViewMode(mode: any) {
  ...
  if (mode === 'overlay') {
    ...
    btnOverlay.classList.add('bg-fuchsia-600');
    btnSide.classList.remove('bg-fuchsia-600');
    ...
    btnOverlay.classList.remove('bg-fuchsia-600');
    btnSide.classList.add('bg-fuchsia-600');
