/*
 * coherentpdf.global.d.ts — TypeScript type definitions for Xtractor / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the Xtractor project.
