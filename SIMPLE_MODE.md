...
```bash
docker run -p 3000:8080 xtractor/xtractor-simple:latest
```

**Using GitHub Container Registry:**

```bash
docker run -p 3000:8080 ghcr.io/alam00000/xtractor-simple:latest
```
...
services:
  xtractor:
    # Using Docker Hub
    image: xtractor/xtractor-simple:latest
    # Or using GitHub Container Registry
    # image: ghcr.io/alam00000/xtractor-simple:latest
...
```bash
docker build --build-arg SIMPLE_MODE=true -t xtractor-simple .
docker run -p 3000:8080 xtractor-simple
```
...
docker pull xtractor/xtractor-simple:latest
docker run -p 3000:8080 xtractor/xtractor-simple:latest
```
...
# Test Simple Mode
docker run -p 3001:8080 xtractor/xtractor-simple:latest
```
...
- `xtractor/xtractor:latest`
- `xtractor/xtractor:v1.0.0` (versioned)

**GitHub Container Registry:**

- `ghcr.io/alam00000/xtractor:latest`
- `ghcr.io/alam00000/xtractor:v1.0.0` (versioned)

### Simple Mode (Clean Interface)

**Docker Hub:**

- `xtractor/xtractor-simple:latest`
- `xtractor/xtractor-simple:v1.0.0` (versioned)

**GitHub Container Registry:**

- `ghcr.io/alam00000/xtractor-simple:latest`
- `ghcr.io/alam00000/xtractor-simple:v1.0.0` (versioned)
...
- **Pre-built images**: Use `xtractor/xtractor-simple:latest` for Simple Mode
