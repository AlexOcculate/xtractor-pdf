...
**Xtractor** is a powerful, privacy-first, client-side PDF toolkit that allows you to manipulate, edit, merge, and process PDF files directly in your browser. No server-side processing is required, ensuring your files remain secure and private.

![GitHub Stars](https://img.shields.io/github/stars/motocaz/xtractor?style=social)
[![Sponsor me on GitHub](https://img.shields.io/badge/Sponsor-%E2%9D%A4-ff69b4)](https://github.com/sponsors/motocaz)
...
- **High Performance**: Built with modern web technologies, Xtractor is fast and efficient, handling even large PDF files with ease.
- **Completely Free**: Xtractor is a free and open-source tool for everyone.

---

## 🛠️ Features / Tools Supported

Xtractor offers a comprehensive suite of tools to handle all your PDF needs.
...
You can run Xtractor locally for development or personal use.
...
You can run Xtractor directly from Docker Hub or GitHub Container Registry without cloning the repository:

**Using Docker Hub:**

```bash
docker run -p 3000:8080 xtractor/xtractor:latest
```

**Using GitHub Container Registry:**

```bash
docker run -p 3000:8080 ghcr.io/motocaz/xtractor:latest
```

Open your browser at: http://localhost:3000

This is the fastest way to try Xtractor without setting up a development environment.
...
services:
  xtractor:
    image: xtractor/xtractor:latest
    container_name: xtractor
    ports:
      - '3000:8080'
...
For organizations that want a clean, distraction-free interface focused solely on PDF tools, Xtractor supports a **Simple Mode** that hides all branding and marketing content.
...
Xtractor runs as a non-root user using nginx-unprivileged for enhanced security:
...
docker run -p 8080:8080 xtractor
```
...
Xtractor supports semantic versioning with multiple Docker tags available on both Docker Hub and GitHub Container Registry:

**Docker Hub:**

- **Latest**: `xtractor/xtractor:latest`
- **Specific Version**: `xtractor/xtractor:1.0.0`
- **Version with Prefix**: `xtractor/xtractor:v1.0.0`

**GitHub Container Registry:**

- **Latest**: `ghcr.io/alam00000/xtractor:latest`
- **Specific Version**: `ghcr.io/alam00000/xtractor:1.0.0`
- **Version with Prefix**: `ghcr.io/alam00000/xtractor:v1.0.0`
...
1. **Clone the Repository**:
   ...
   ```bash
   git clone https://github.com/motocaz/xtractor.git
   cd xtractor
   ```
...
Xtractor was originally built using **HTML**, **CSS**, and **vanilla JavaScript**. As the project grew, it was migrated to a modern stack for better maintainability and scalability:
...
Have an idea for a new tool or an improvement? [Open an issue](https://github.com/alam00000/xtractor/issues) to discuss it first.

---

## Special Thanks

Xtractor wouldn't be possible without the amazing open-source tools and libraries that power it. We'd like to extend our heartfelt thanks to the creators and maintainers of:
...
This project is licensed under the **GNU AGPLv3**. See the [LICENSE](https://github.com/motocaz/xtractor/blob/main/LICENSE) file for details.
